...
import { MongoBackofficeCandidateTestRepositroy } from "../../../../test/contexts/backoffice/infrastructure/BackofficeCandidateTestRepositroy";
...
function bind(container: Container) {
  if (["test", "development"].includes(process.env.NODE_ENV!)) {
    ...
    container.bind(types.CandidateRepository).to(MongoBackofficeCandidateTestRepositroy).inSingletonScope();
  }
