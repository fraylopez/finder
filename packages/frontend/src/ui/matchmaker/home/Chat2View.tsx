   ...
   <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
      <div className="relative flex items-center space-x-4">
         ...
         <div className="flex flex-col leading-tight">
            ...
            <span className="text-lg text-gray-600">{ isTyping ? "is typing..." : "Junior Developer"}</span>
         </div>
      </div>
      ...
      {messages.map((message) => message.from === "you" ? (
        <div className="chat-message">
          <div className="flex items-end justify-end">
            ...
            <img src="https://images.unsplash.com/photo-1590031905470-a1a1feacbb0b?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="My profile" className="w-8 h-8 md:w-12 md:h-12 rounded-full order-2" />
          </div>
      </div>
      ) : (
        <div className="chat-message">
        <div className="flex items-end">
          ...
          <img src="https://images.unsplash.com/photo-1549078642-b2ba4bda0cdb?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144" alt="My profile" className="w-8 h-8 md:w-12 md:h-12 rounded-full order-1" />
        </div>
    </div>
      ))}
   </div>
      ...
      <div className="relative flex">
         <div className="flex-1 items-center inset-y-0 hidden sm:flex">
           {nextOptions.map(option => (
            <button type="button" className="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none" onClick={() => onSubmit(option)}>
